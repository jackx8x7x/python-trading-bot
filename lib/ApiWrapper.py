...
import json
import logging
from .api import account, transaction, position, order, instrument, trade, pricing
...
class ApiWrapper:
	...
	async def getInstrumentPrices(self, instruments):
		return await pricing.getInstrumentPrices(self, instruments)
